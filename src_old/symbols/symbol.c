...
Symbol get_symbol_from_char(char character) {
    switch (character) {
        ...
        case '"':
            return SYMBOL_QUOTATION;
        case '<':
            return SYMBOL_OPEN_ANGLE;
        case '>':
            return SYMBOL_CLOSE_ANGLE;
        case ',':
            return SYMBOL_COMMA;
        case '.':
...
char* get_string_from_symbol(Symbol symbol) {
    switch (symbol) {
        ...
        case SYMBOL_SEMICOLON:
            return ";";
        case SYMBOL_OPEN_ANGLE:
            return "<";
        case SYMBOL_CLOSE_ANGLE:
            return ">";
        case SYMBOL_COMMA:
            return ",";
        case SYMBOL_PERIOD:
...
Symbol get_keyword_from_str(char* str) {
    ...
    if (strcmp(str, "extends") == 0) {
        return KEYWORD_EXTENDS;
    }
    if (strcmp(str, "finally") == 0) {
    ...
    if (strcmp(str, "priv") == 0) {
        return KEYWORD_PRIV;
    }
    if (strcmp(str, "prot") == 0) {
        return KEYWORD_PROT;
    }
    if (strcmp(str, "pub") == 0) {
        return KEYWORD_PUB;
    ...
    if (strcmp(str, "==") == 0) {
        return OPERATOR_EQUIVALENCE;
    }
    if (strcmp(str, "!=") == 0) {
        return OPERATOR_NOT_EQUIVALENCE;
    }
    if (strcmp(str, ">=") == 0) {
    ...
    if (strcmp(str, "%=") == 0) {
        return OPERATOR_MODULUS_ASSIGNMENT;
    }
    if (strcmp(str, "&=") == 0) {
        return OPERATOR_BITWISE_AND_ASSIGNMENT;
    }
    if (strcmp(str, "|=") == 0) {
        return OPERATOR_BITWISE_OR_ASSIGNMENT;
    }
    if (strcmp(str, "^=") == 0) {
        return OPERATOR_BITWISE_XOR_ASSIGNMENT;
    }
    if (strcmp(str, "<<") == 0) {
    ...
    if (strcmp(str, ">>>") == 0) {
        return OPERATOR_RIGHT_SHIFT_UNSIGNED;
    }
    if (strcmp(str, "!") == 0) {
        return OPERATOR_NOT;
    }
    ...
    if (strcmp(str, "[]") == 0) {
        return OPERATOR_ARRAY_DECLARATION;
    }
