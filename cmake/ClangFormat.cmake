...
if(CLANG_FORMAT_EXE)
    ...
    add_custom_target(jakarta-clang-format
        COMMAND ${CLANG_FORMAT_EXE} -i -style=file ${JAKARTA_FORMAT_SOURCES}
        COMMENT "Running jakarta-clang-format..."
        USES_TERMINAL
        VERBATIM
    )

    add_custom_target(jakarta-clang-format-check
        COMMAND ${CLANG_FORMAT_EXE} --dry-run --Werror -style=file ${JAKARTA_FORMAT_SOURCES}
        COMMENT "Running jakarta-clang-format check..."
        USES_TERMINAL
        VERBATIM
    )
else()
